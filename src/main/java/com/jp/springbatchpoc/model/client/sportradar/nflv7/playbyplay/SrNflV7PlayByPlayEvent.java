...
public class SrNflV7PlayByPlayEvent {
    ...
    private List<SrNflV7PlayByPlayDetail> details;
    ...
    @JsonProperty("score")
    private SrNflV7PlayByPlayScore score;
    ...
    private List<SrNflV7PlayByPlayStatistic> statistics;
    ...
    public List<SrNflV7PlayByPlayDetail> getDetails() {
    ...
    public Optional<SrNflV7PlayByPlayScore> getScore() {
    ...
    public List<SrNflV7PlayByPlayStatistic> getStatistics() {
