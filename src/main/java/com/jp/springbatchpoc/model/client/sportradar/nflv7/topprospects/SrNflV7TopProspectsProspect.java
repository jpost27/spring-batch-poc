...
public class SrNflV7TopProspectsProspect {
    @JsonProperty("birth_place")
    private String birthPlace;

    @JsonProperty("conference")
    private SrNflV7TopProspectsConference conference;

    @JsonProperty("division")
    private SrNflV7TopProspectsDivision division;
    ...
    @JsonProperty("team")
    private SrNflV7TopProspectsTeam team;
    ...
    public Optional<SrNflV7TopProspectsConference> getConference() {
        return Optional.ofNullable(conference);
    }

    public Optional<SrNflV7TopProspectsDivision> getDivision() {
    ...
    public Optional<SrNflV7TopProspectsTeam> getTeam() {
