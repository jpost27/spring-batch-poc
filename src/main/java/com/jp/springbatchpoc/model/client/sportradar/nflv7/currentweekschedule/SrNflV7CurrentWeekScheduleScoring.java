...
public class SrNflV7CurrentWeekScheduleScoring {
    ...
    private List<SrNflV7CurrentWeekSchedulePeriod> periods;
    ...
    public List<SrNflV7CurrentWeekSchedulePeriod> getPeriods() {
