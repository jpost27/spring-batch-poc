...
public class SrNflV7ProspectsProspect {
    @JsonProperty("birth_place")
    private String birthPlace;

    @JsonProperty("conference")
    private SrNflV7ProspectsConference conference;

    @JsonProperty("division")
    private SrNflV7ProspectsDivision division;
    ...
    @JsonProperty("team")
    private SrNflV7ProspectsTeam team;
    ...
    public Optional<SrNflV7ProspectsConference> getConference() {
        return Optional.ofNullable(conference);
    }

    public Optional<SrNflV7ProspectsDivision> getDivision() {
    ...
    public Optional<SrNflV7ProspectsTeam> getTeam() {
