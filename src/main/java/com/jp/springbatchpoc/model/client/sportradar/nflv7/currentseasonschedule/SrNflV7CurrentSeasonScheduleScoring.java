...
public class SrNflV7CurrentSeasonScheduleScoring {
    ...
    private List<SrNflV7CurrentSeasonSchedulePeriod> periods;
    ...
    public List<SrNflV7CurrentSeasonSchedulePeriod> getPeriods() {
