...
public class SrNflV7CurrentWeekScheduleVenue {
    ...
    private SrNflV7CurrentWeekScheduleLocation location;
    ...
    public Optional<SrNflV7CurrentWeekScheduleLocation> getLocation() {
